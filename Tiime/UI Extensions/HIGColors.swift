...
extension HIGColor: RawRepresentable, CaseIterable {
	...
	var rawValue: RawValue {
		switch self {
		case .red: return UIColor(red: 255, green: 59, blue: 48, alpha: 1)
		case .orange: return UIColor(red: 255, green: 149, blue: 0, alpha: 1)
		case .yellow: return UIColor(red: 255, green: 204, blue: 0, alpha: 1)
		case .green: return UIColor(red: 76, green: 217, blue: 100, alpha: 1)
		case .tealBlue: return UIColor(red: 90, green: 200, blue: 250, alpha: 1)
		case .blue: return UIColor(red: 0, green: 122, blue: 255, alpha: 1)
		case .purple: return UIColor(red: 88, green: 86, blue: 214, alpha: 1)
		case .pink: return UIColor(red: 255, green: 45, blue: 85, alpha: 1)
		}
	}
}
